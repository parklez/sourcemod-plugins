...
void Perk_InstaKill_Apply(int client, char[] buffName, int maxLenBuff, char[] expireMsg, int maxLenExpire, float &duration)
{
    duration = g_cvPerkInstaKillDuration.FloatValue;
